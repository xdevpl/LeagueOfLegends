...
public class Hologram {
	...
	/*
	 * Holograms By Dzikoysk (github.com/dzikoysk) Dzieki!
	 */
	...
	private static List<Integer> showLine(Location loc, String text) {
		...
		try {
			...
			ReflectionUtils.getMethod(EntityWitherSkull, "setLocation", double.class, double.class, double.class,
			...
			ReflectionUtils.getMethod(EntityHorse, "setLocation", double.class, double.class, double.class, float.class,
